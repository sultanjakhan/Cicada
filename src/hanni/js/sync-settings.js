...
export function mountSyncSettings(element, { invoke, setPending = () => {} }) {
  ...
  const credentialError = 'Нет доступа к сохранённому ключу синхронизации. Локальные данные сохранены. После восстановления доступа к хранилищу ключей перезапусти Hanni.';
