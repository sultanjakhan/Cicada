...
Последнее предложение по упрощению карточки ещё **не реализовано**: связать
этап с его прогрессом, убрать повтор темы и декоративную иконку у навыка,
выровнять действия и уменьшить отступы. Это предложение для следующей итерации,
а не уже утверждённая замена v7.
