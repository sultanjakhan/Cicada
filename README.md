...
Tauri 2 · Rust · SQLite · JavaScript. Версия 0.2.0.
...
- Светлая и тёмная темы, ручная резервная копия SQLite.
...
«Настройки → Создать резервную копию» сохраняет файл в подкаталоге `backups`.
