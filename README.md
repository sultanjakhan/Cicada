...
Tauri 2 · Rust · SQLite · JavaScript. Версия исходников 0.3.16.
...
Скачай установщик из [последнего релиза](https://github.com/sultanjakhan/hanni-mvp/releases/latest):

- Windows x64: файл `.exe`.
- Android ARM64: файл `.apk`; разреши установку из выбранного источника.
- macOS: пока сборка из исходников по [инструкции](docs/macos-build.md).
